...
import 'package:sahyog2/screens/rescue_homepage.dart';

enum RescueAuth { login, signup }

class RescueAuthController extends GetxController {
  GlobalKey<FormState> loginFormKey = GlobalKey<FormState>();
  GlobalKey<FormState> signupFormKey = GlobalKey<FormState>();
  var phoneController = TextEditingController();
  var passwordController = TextEditingController();
  var nameController = TextEditingController();
  RescueAuth rescueAuth = RescueAuth.login;
  GlobalController globalController = Get.find();
  late DatabaseReference RescueCredRef;

  @override
  void onInit() {
    // TODO: implement onInit
    super.onInit();
    RescueCredRef = FirebaseDatabase.instance.ref("rescueCred");
  }
  ...
  signUp() {
    ...
    RescueCredRef = FirebaseDatabase.instance.ref("rescueCred");
    RescueCredRef.child(phoneController.text).set({
      ...
      // subscribeToConfig(data.child("pinCode").value.toString(),
      //     data.child("mainDeptType").value.toString());
      saveDetails();
    });
  }
  ...
  loginCheckCred() async {
    ...
    DataSnapshot data = await RescueCredRef.child(phoneController.text).get();
  ...
  subscribeToConfig(String pinCode, String mainDeptType) {
    FirebaseMessaging.instance.subscribeToTopic(pinCode);
    FirebaseMessaging.instance.subscribeToTopic(mainDeptType);
  }
